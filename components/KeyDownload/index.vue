<template>
    <div class="p-4 bg-background rounded flex-row">
        ...
        <div class="pt-4">
            ...
            <Input label="Filename" placeholder="mawthuq_software.conf" type="text" @data-change="filenameChange"/>
            <div class="pt-6">
                <Button label="Download" @btn-click="downloadConfig"/>
            </div>
        </div>
        <div class="pt-8 pb-4">
            <p class="text-white font-bold pb-4">Scan QR code with mobile to import into Wireguard.</p>
            <qrcode-vue :id="qrID" :value="confString" size="200" level="Q" background="#202427" foreground="#ffffff"/>
        </div>
    </div>
</template>
<script>
